...
set I := {i in 1..300}; #Pontos de demanda
...
minimize Custo:
    ...
    # Custo variável por parciente
    + sum{p in P, i in I, j1 in L[1]}D1[i,j1]*VC1[p,j1]*u1[p,i,j1] + sum{p in P, j1 in L[1], j2 in L[2]}D2[j1,j2]*VC2[p,j2]*u2[j1,j2] + sum{p in P, j2 in L[2], j3 in L[3]}D3[j2,j3]*VC3[p,j3]*u3[j2,j3];
...
printf "\n===================================================\n";
printf "Planejamento Poços de Caldas\n";
printf "===================================================\n\n";
